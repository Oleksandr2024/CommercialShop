...
const reducer = (
  ...
  switch (action.type) {
    case REDUCER_ACTION_TYPE.ADD: {
      ...
      const selectedItem: CartItemType | undefined = state.cart.find(
        (item) => item.sku === sku
      );
      const qty = selectedItem ? selectedItem.qty + 1 : 1;
    ...
    case REDUCER_ACTION_TYPE.QUANTITY: {
      ...
      if (!selectedItem) {
        throw new Error("Item must exist to manage the quantity");
      }
      const updatedItem: CartItemType = { ...selectedItem, qty };
